  ...
  return (
    <div className="content">
      <section>
        ...
        <img
          src={triangleIcon}
          alt="Diagram of a triangle showing it contains angles a1, a2, and a3 and sides S1, S2, and S3. angle 1 is between sides s1 and 2, angle 2 is between sides s2 and 3, angle three is between sides s3 and 1."
          height="300"
          width="300"
        />
        <br />
        <br />
        <ul>
          Calculate the remaining angles or side lengths of a triangle by
          entering either:
        ...
        <p>
          You may also enter two sides and the angle not between them, though
          this may comprise an invalid triangle.
        </p>
        <br />
      </section>
      ...
      <section>
        <button className="btn" type="button" onClick={handleTriangle}>
